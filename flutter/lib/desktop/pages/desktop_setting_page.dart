        ...
        child: _Card(title: translate('About RustDesk'), children: [
          Column(
            ...
            children: [
              ...
              InkWell(
                  onTap: () {
                    launchUrlString('https://www.doctipro.lu');
                  },
                  child: Text(
                    translate('Website'),
                    style: linkStyle,
              ...
              Container(
                decoration: const BoxDecoration(color: Color(0xFF0A5560)),
                padding:
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Doctipro Assist — Copyright © ${DateTime.now().toString().substring(0, 4)} Doctipro\n$license',
